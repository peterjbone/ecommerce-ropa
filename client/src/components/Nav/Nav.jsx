	...
	return (
		<>
			<nav className="nav-bar">
				...
				<button className="nav-bar-button" onClick={goToStore}>
					Tienda
				</button>
				<div>
					<button className="nav-bar-search-button" onClick={handleSearch}>
						<FaSearch size={35} />
					</button>
					<input
						type="search"
				...
				{/* DARK MODE */}
				<button className="nav-bar-button theme-button" onClick={toggleTheme}>
