	...
	const submitHandler = async (e) => {
		...
		if (isValid) {
			try {
				...
				axios.post(`${VITE_BACK_URL}/createproduct`, {
					...form,
					imagenes: arr
				});
	...
	return (
		<div className={styles.container}>
			...
			<form className={styles.formContainer} onSubmit={submitHandler}>
				<div>
					<label className={styles.labelFormContainer}>Nombre: </label>
					<br></br>
					<input
					...
					/>
					{errors.nombre && (
						<span className={styles.spanErrorNotification}>
							{errors.nombre}
						</span>
					)}
				</div>
				<div>
					<label className={styles.labelFormContainer}>Marca: </label>
					<br></br>
					<select
						className={styles.inputFormContainer}
						name="marca"
					...
					{errors.marca && (
						<span className={styles.spanErrorNotification}>{errors.marca}</span>
					)}
				</div>
				<div>
					<label className={styles.labelFormContainer}>Precio: </label>
					<br></br>
					<input
						className={styles.inputFormContainer}
						type="text"
				...
				<div>
					<label className={styles.labelFormContainer}>Categoria: </label>
					<br></br>
					<select
						className={styles.inputFormContainer}
						name="categoria"
				...
				<div>
					<label className={styles.labelFormContainer}>Sub-categoria: </label>
					<br></br>
					<select
						className={styles.inputFormContainer}
						name="subcategoria"
				...
				<div>
					<label className={styles.labelFormContainer}>Género: </label>
					<br></br>
					<select
						className={styles.inputFormContainer}
						name="genero"
				...
				<div>
					<label className={styles.labelFormContainer}>Descripción: </label>
					<br></br>
					<textarea
						className={styles.inputFormContainer}
						name="descripcion"
				...
				<button onClick={buttonStockHandler} type="button">
					Agregar stock
				</button>
