...
export default function UserDashboard() {
	...
	const handleUserDataChange = (event) => {
		...
		if (
			!isUserDataChanged &&
			(event.target.type !== "email" || event.target.type !== "password")
		) {
			...
			<aside className="user-options-container">
				...
				<button
					className={`nav-bar-button ${
						activeOption === "userData" ? "activeUserTab" : ""
					}`}
					onClick={() => handleOptionClick("userData")}>
					Información personal
				</button>
				<button
					className={`nav-bar-button dashboard-button ${
						activeOption === "email" ? "activeUserTab" : ""
					}`}
				...
				<button
					className={`nav-bar-button dashboard-button ${
						activeOption === "password" ? "activeUserTab" : ""
					}`}
				...
				<button
					className={`nav-bar-button dashboard-button ${
						activeOption === "favorites" ? "activeUserTab" : ""
					}`}
				...
				<button
					className={`nav-bar-button dashboard-button ${
						activeOption === "purchases" ? "activeUserTab" : ""
					}`}
				...
				<button
					className={`nav-bar-button dashboard-button ${
						activeOption === "reviews" ? "activeUserTab" : ""
					}`}
				...
				<button
					className={`nav-bar-button dashboard-button ${
						activeOption === "deleteAccount" ? "activeUserTab" : ""
					}`}
					onClick={() => handleOptionClick("deleteAccount")}>
					Eliminar Cuenta
				</button>
				<button
					className={`nav-bar-button dashboard-button logout-button ${
						activeOption === "logout" ? "activeUserTab" : ""
					}`}
						...
						case "userData":
							return (
								<form onSubmit={handleUserDataChangeSubmit}>
									...
									<p className={changeDataErrors.name ? "" : "invisible"}>
										{changeDataErrors.name
											? `${changeDataErrors.name}`
											: "invisible"}
									</p>
									<div className="user-data-input-label-container">
									...
									<p className={changeDataErrors.surName ? "" : "invisible"}>
										{changeDataErrors.surName
											? `${changeDataErrors.surName}`
											: "invisible"}
									</p>
									<div className="user-data-input-label-container">
									...
									<p className={changeDataErrors.userName ? "" : "invisible"}>
										{changeDataErrors.userName
											? `${changeDataErrors.userName}`
											: "invisible"}
									</p>
									<div className="user-data-input-label-container">
									...
									<div className="user-data-input-label-container">
										<label htmlFor="changeDateOfBirth">
											Fecha De Nacimiento
										</label>
										<input
											type="date"
									...
									<p
										className={changeDataErrors.dateOfBirth ? "" : "invisible"}>
										{changeDataErrors.dateOfBirth
											? `${changeDataErrors.dateOfBirth}`
											: "invisible"}
									</p>
									<p className={changeDataErrors.userData ? "" : "invisible"}>
										{changeDataErrors.userData
											? `${changeDataErrors.userData}`
											: "invisible"}
									</p>
									<button
						...
						case "email":
							return (
								<form onSubmit={handleUserEmailChangeSubmit}>
									...
									<p className={changeDataErrors.email ? "" : "invisible"}>
										{changeDataErrors.email
											? `${changeDataErrors.email}`
											: "invisible"}
									</p>
									<div className="user-data-input-label-container">
									...
									<p className={changeDataErrors.newEmail ? "" : "invisible"}>
										{changeDataErrors.newEmail
											? `${changeDataErrors.newEmail}`
											: "invisible"}
									</p>
									<div className="user-data-input-label-container">
									...
									<p
										className={
											changeDataErrors.emailPassword ? "" : "invisible"
										}>
										{changeDataErrors.emailPassword
											? `${changeDataErrors.emailPassword}`
											: "invisible"}
									</p>
									<button
						...
						case "password":
							return (
								<form onSubmit={handleUserPasswordChangeSubmit}>
									...
									<p className={changeDataErrors.password ? "" : "invisible"}>
										{changeDataErrors.password
											? `${changeDataErrors.password}`
											: "invisible"}
									</p>
									<div className="user-data-input-label-container">
									...
									<p
										className={changeDataErrors.newPassword ? "" : "invisible"}>
										{changeDataErrors.newPassword
											? `${changeDataErrors.newPassword}`
											: "invisible"}
									</p>
									<div className="user-data-input-label-container">
									...
									<p
										className={
											changeDataErrors.repeatPassword ? "" : "invisible"
										}>
										{changeDataErrors.repeatPassword
											? `${changeDataErrors.repeatPassword}`
											: "invisible"}
									</p>
									<button
							...
							return (
								<>
									<form onSubmit={handleReauthentication}>
										...
										<p
											className={
												changeDataErrors.deletePassword ? "" : "invisible"
											}>
											{changeDataErrors.deletePassword
												? `${changeDataErrors.deletePassword}`
												: "invisible"}
										</p>
										<button
									...
									{isDeleteAccountModalOpen && (
										<div className="modal-overlay">
											<div className="delete-account-modal">
												...
												<p>
													Esta acción es irreversible. ¿Está seguro de que desea
